...
source(here::here("demo/my_functions.R"))
g("a")
traceback()
```
...
Automatically invoke interactive debugger on error.

![](img/break-in-code.png)
...
`debug()` = `browser()` in first line of function
 ...
 * depending on function internals, this can be... buggy


## debugonce() 

`debugonce()` = `browser()` in first line of function

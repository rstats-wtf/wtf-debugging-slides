...
_uncheck_ `Use debug error handler only when my code contains errors.`
:::
...
::: footer
From _Package development with devtools_ RStudio cheatsheet <br>
...
2.  Look in [github.com/wch/r-source/src/main/names.c](https://github.com/wch/r-source/blob/trunk/src/main/names.c) to find the name of the [internal function](https://github.com/wch/r-source/blob/4a73802c7d6de8670cfe8b9301232cbf2b63a201/src/main/names.c#L615). Or in GitHub search bar: `is.na filename:names.c`.
